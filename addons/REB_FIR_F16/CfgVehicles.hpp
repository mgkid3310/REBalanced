...
class CfgVehicles {
	...
	class FIR_F16_Base: Plane_Fighter_03_base_F { // Blk 50
		...
		elevatorCoef[] = {0.2, 0.196, 0.19, 0.18, 0.168, 0.156, 0.15, 0.17, 0.38, 0.3, 0.25, 0.212, 0.186, 0.172, 0.164, 0.16, 0.16, 0.16, 0.16, 0.16};
		aileronCoef[] = {0.3, 0.294, 0.285, 0.27, 0.252, 0.234, 0.225, 0.255, 0.57, 0.45, 0.375, 0.318, 0.279, 0.258, 0.246, 0.24, 0.24, 0.24, 0.24, 0.24};
		rudderCoef[] = {0.4, 0.392, 0.38, 0.36, 0.336, 0.312, 0.3, 0.34, 0.76, 0.6, 0.5, 0.424, 0.372, 0.344, 0.328, 0.32, 0.32, 0.32, 0.32, 0.32};
