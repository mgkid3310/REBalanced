...
class CfgVehicles {
	...
	class FIR_F16_Base: Plane_Fighter_03_base_F { // Blk 50
		...
		elevatorCoef[] = {0.3, 0.294, 0.288, 0.282, 0.276, 0.273, 0.27, 0.306, 0.675, 0.54, 0.435, 0.375, 0.33, 0.315, 0.306, 0.3, 0.3, 0.3, 0.3, 0.3};
		aileronCoef[] = {0.4, 0.392, 0.384, 0.376, 0.368, 0.364, 0.36, 0.408, 0.9, 0.72, 0.58, 0.5, 0.44, 0.42, 0.408, 0.4, 0.4, 0.4, 0.4, 0.4};
