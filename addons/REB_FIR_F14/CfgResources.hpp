...
class RscInGameUI {
	...
	class Rsc_REB_F14_UnitInfo: RscUnitInfoAirPlane {
		...
		controls[] = {
			...
			"CA_Alt",
			//"CA_Radar",
			"REB_F14_External_fuel_Progress",
			"REB_F14_Afterburner_Status",
			"REB_F14_Tailhook_Status",
			"CA_Throttle"
		};
		...
		class REB_F14_External_fuel_Progress: CA_ValueFuel {
			idc = 9910;
		...
		class REB_F14_Tailhook_Status: RscPicture {
			colorText[] = {
			...
			idc = 9907;
			text = "REB_FIR_F14\ui\FA18_Toggles_clear_ca.paa";
		...
		class REB_F14_Afterburner_Status: RscPicture {
			colorText[] = {
				"(profilenamespace getvariable ['IGUI_TEXT_RGB_R',0])",
				"(profilenamespace getvariable ['IGUI_TEXT_RGB_G',1])",
				"(profilenamespace getvariable ['IGUI_TEXT_RGB_B',1])",
