...
class RscInGameUI {
	...
	class Rsc_REB_FA18CD_UnitInfo: RscUnitInfoAirPlane {
		...
		controls[] = {
			...
			"CA_Alt",
			//"CA_Radar",
			"REB_FA18CD_External_fuel_Progress",
			"REB_FA18CD_Afterburner_Status",
			"REB_FA18CD_Tailhook_Status",
			"CA_Throttle"
		};
		...
		class REB_FA18CD_External_fuel_Progress: CA_ValueFuel {
			idc = 9910;
		...
		class REB_FA18CD_Tailhook_Status: RscPicture {
			colorText[] = {
			...
			idc = 9907;
			text = "REB_FIR_FA18CD\ui\toggles_clear_ca.paa";
		...
		class REB_FA18CD_Afterburner_Status: RscPicture {
			colorText[] = {
				"(profilenamespace getvariable ['IGUI_TEXT_RGB_R',0])",
				"(profilenamespace getvariable ['IGUI_TEXT_RGB_G',1])",
				"(profilenamespace getvariable ['IGUI_TEXT_RGB_B',1])",
